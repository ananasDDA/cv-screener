    ...
    def identity(self, seed: int) -> Persona:
        ...
        if self.name_override:
            ...
            first = (
                ...
                if self.gender == "male"
                else fake.first_romanized_name_female()
            )
        ...
        self.full_name = re.sub(
            r"\b(Dr|Prof|Mr|Mrs|Ms|Ing|Dipl\.-Ing|Herr|Frau|Sr|Sra|Dott)\.?\s+", "", name
        ).strip()
        ...
        wants_github = self.role_family not in {"product", "qa"} or self.seniority in {
            "senior",
            "lead",
        }
        self.github = (
            f"github.com/{slug.split('-')[0]}{fake.random_int(2, 98)}" if wants_github else None
        )
        return self
...
PERSONAS: list[Persona] = [
    Persona(
        ...
        "MSc Computer Science from a German TU",
        "Berlin scale-ups and one large e-commerce company",
        "modern",
        "short beard, glasses",
    ),
    Persona(
        ...
        "MSc in Data Science, BSc Mathematics",
        "a bank, a travel marketplace and an ML consultancy",
        "classic",
        "long dark hair",
    ),
    Persona(
        ...
        "BSc Computer Science, in progress or just finished",
        "one internship and one product startup",
        "minimal",
        "blonde hair",
    ),
    Persona(
        ...
        [("English", "C2"), ("Hindi", "Native"), ("Kannada", "Native")],
        "BTech from an NIT or IIT",
        "an IT services giant then a fintech",
        "classic",
    ),
    Persona(
        "p05",
        ...
        [("Dutch", "Native"), ("English", "C2")],
        "HBO Bachelor in Informatics",
        "a telecom, a payments company and a cloud-native scale-up",
        "modern",
        "shaved head",
    ),
    Persona(
        ...
        [("Portuguese", "Native"), ("Spanish", "B2"), ("English", "C1")],
        "BSc Software Engineering",
        "an outsourcing firm and a SaaS company",
        "minimal",
        "curly hair",
    ),
    Persona(
        ...
        "Licenciatura en Sistemas from UBA",
        "a LatAm fintech and remote US clients",
        "classic",
    ),
    Persona(
        "p08",
        ...
        [("English", "Native"), ("French", "C1"), ("Mandarin", "B1")],
    ...
    Persona(
        ...
        [("Armenian", "Native"), ("Russian", "C1"), ("English", "B1")],
        "BSc from Yerevan State University or NPUA",
        "a bootcamp-style internship and a local outsourcing company",
        "minimal",
        name_override="Davit Petrosyan",
    ),
    Persona(
        "p10",
        "ml",
        ...
        "PhD in Computational Linguistics from Edinburgh or Cambridge",
        "a university lab, a big-tech research group and an AI startup",
        "classic",
        "grey-streaked hair",
    ...
    Persona(
        ...
        [("Swedish", "Native"), ("English", "C2"), ("Spanish", "A2")],
        "MSc Industrial Engineering from KTH",
        "a music streaming company and a B2B SaaS",
        "modern",
    ),
    Persona(
        "p12",
        ...
        "BSc Computer Engineering from USP or Unicamp",
        "a large Brazilian bank and a delivery app",
        "classic",
    ),
    Persona(
        "p13",
        ...
        [("Japanese", "Native"), ("English", "B2")],
        "BEng from a Japanese national university",
        "a Japanese e-commerce giant and a crypto exchange",
        "minimal",
    ),
    Persona(
        "p14",
        ...
        "BSc Computer Science from UNAM, OSCP",
        "a cybersecurity consultancy and a neobank",
        "modern",
    ),
]
